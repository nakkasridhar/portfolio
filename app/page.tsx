  ...
  return (
    <main style={{fontFamily: "Segoe UI, Arial, sans-serif", background: "#f4f6fa", color: "#222", minHeight: "100vh"}}>
      <div style={{
        ...
        <h1 style={{color: "#2d5c9f", fontSize: "2.4rem", letterSpacing: 1}}>Sridhar Nakka. </h1>
        <h1 style={{color: "#2d5c9f", fontSize: "2.4rem", letterSpacing: 1}}>Platform Engineer/On-prem/GCP/AWS/Azure Infra DevOps Engineer/Leader</h1>
